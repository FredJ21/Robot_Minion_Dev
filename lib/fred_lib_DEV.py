...
class data_filter(object):
    ...
    # ------------------------------
    def add(self, data_name, val):

        if data_name not in self.DATA :
            self.DATA[data_name] =  [ val ] * self.buffer_size

        if len(self.DATA[data_name]) >= self.buffer_size :
            self.DATA[data_name].pop(0)
    ...
    # ------------------------------
    def data_sum(self, data_name):

        return sum(self.DATA[data_name])

    # ------------------------------
    def data_average(self, data_name):

        return sum(self.DATA[data_name]) / len(self.DATA[data_name])

    # ------------------------------
    def add_and_average(self, data_name, val):

        self.add(data_name, val)

        return self.data_average( data_name )
